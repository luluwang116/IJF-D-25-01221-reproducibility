Replication package for "Modeling Asymmetric Risk Contagion between Chinese and Global Commodity Markets: A Network Quantile GARCH Approach"
...
Data set
The file 'final return 2016.csv' contains daily return of global commodities from January 2016 to December 2024 collected from the WIND database. The file 'staticnet.csv' is the weighted matrix generated from 'final return 2016.csv'. The file 'simulation_coef_network.csv' contains the coefficients used for data generation process in simulation. The file 'simulateweight.csv' is the weight matrix used for data generation process in simulation.
...
(2) The file 'Table2.R' and 'Table5.R' produces rejection rates. Minor differences in UC, CC, and DQ rejection rates may occur due to finite-sample initialization effects. The MAEs remain essentially unchanged, and the qualitative conclusions are unaffected.
