...
W<-as.matrix(staticnet$tables[[1]])
write.csv(W,"staticnet.csv")
...
dim(return0)
return0<-t(return0)
Wmatrix<-read.csv("staticnet.csv",header = TRUE)
Wmatrix<-Wmatrix[,-1]
dim(Wmatrix)
W<-as.matrix(Wmatrix)
X<-return0
...
###############################
####################################################
qfit1<-CQEst(tau=0.1,p=1,q=1,L=30,X=return0,B=1000,W=W)
phybrid1<-2*pt(-abs(qfit1$thetahat/qfit1$sdE),df=T-4)
write.csv(qfit1$thetahat,file="coef-tau01.csv")
write.csv(phybrid1,file="pvalue-tau01.csv")
######################################################
qfit2<-CQEst(tau=0.25,p=1,q=1,L=30,X=return0,B=1000,W=W)
phybrid2<-2*pt(-abs(qfit2$thetahat/qfit2$sdE),df=T-4)
write.csv(qfit2$thetahat,file="coef-tau025.csv")
write.csv(phybrid2,file="pvalue-tau025.csv")
######################################################
qfit3<-CQEst(tau=0.5,p=1,q=1,L=30,X=return0,B=1000,W=W)
phybrid3<-2*pt(-abs(qfit3$thetahat/qfit3$sdE),df=T-4)
write.csv(qfit3$thetahat,file="coef-tau05.csv")
write.csv(phybrid3,file="pvalue-tau05.csv")
#######################################################
qfit4<-CQEst(tau=0.75,p=1,q=1,L=30,X=return0,B=1000,W=W)
phybrid4<-2*pt(-abs(qfit4$thetahat/qfit4$sdE),df=T-4)
write.csv(qfit4$thetahat,file="coef-tau075.csv")
write.csv(phybrid4,file="pvalue-tau075.csv")
#######################################################
qfit5<-CQEst(tau=0.9 ,p=1,q=1,L=30,X=return0,B=1000,W=W)
phybrid5<-2*pt(-abs(qfit5$thetahat/qfit5$sdE),df=T-4)
write.csv(qfit5$thetahat,file="coef-tau09.csv")
write.csv(phybrid5,file="pvalue-tau09.csv")
#######################################################
coef01<-read.csv("coef-tau01.csv",header = TRUE)
coef025<-read.csv("coef-tau025.csv",header = TRUE)
coef05<-read.csv("coef-tau05.csv",header = TRUE)
coef075<-read.csv("coef-tau075.csv",header = TRUE)
coef09<-read.csv("coef-tau09.csv",header = TRUE)
pvalue01<-read.csv("pvalue-tau01.csv", header = TRUE)
pvalue025<-read.csv("pvalue-tau025.csv", header = TRUE)
pvalue05<-read.csv("pvalue-tau05.csv", header = TRUE)
pvalue075<-read.csv("pvalue-tau075.csv", header = TRUE)
pvalue09<-read.csv("pvalue-tau09.csv", header = TRUE)
