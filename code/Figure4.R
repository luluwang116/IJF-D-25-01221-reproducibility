...
########################################################
######################################################
set.seed(123456881)##tau=0.1, T=1000 and student t5
n <- 30
T <- 1050
S <- 500
...
garchcoeftau<--(qt(0.1,df=5)/sqrt(5/3))^2*garchcoef
bias1<-matrix(0,30,4)
for (i in 1:30) {
...
bias1
##################################################
set.seed(123456882)##tau=0.1, T=1500 and student t5
n <- 30
T <- 1550
S <- 500
...
bias011000<-bias1
bias011500<-bias2
alpha001<-cbind(bias011000[,1],bias011500[,1])
colnames(alpha001)<-c("T=1000","T=1500")
boxplot(alpha001,col="skyblue",xlab="alpha0",ylab="Bias",medcol="royalblue",border="skyblue")
alpha101<-cbind(bias011000[,2],bias011500[,2])
colnames(alpha101)<-c("T=1000","T=1500")
boxplot(alpha101,col="skyblue",xlab="alpha1",ylab="Bias",medcol="royalblue",border="skyblue")
beta01<-cbind(bias011000[,3],bias011500[,3])
colnames(beta01)<-c("T=1000","T=1500")
boxplot(beta01,col="skyblue",xlab="beta",ylab="Bias",medcol="royalblue",border="skyblue")
lambda01<-cbind(bias011000[,4],bias011500[,4])
colnames(lambda01)<-c("T=1000","T=1500")
boxplot(lambda01,col="skyblue",xlab="lambda",ylab="Bias",medcol="royalblue",border="skyblue")
